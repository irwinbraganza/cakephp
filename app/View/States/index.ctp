<div class="states index">
	...
	<tr>
		...
		<td class="actions">
			            ...
			            "alt" => "Edit",
			            'url' => array('action' => 'view', $state['State']['id'])
			            ));?> 

			            <?php echo $this->Html->image('edit.gif', array(
			            'width'=>'15px','height'=>'15px',
			            "alt" => "Edit",
			            'url' => array('action' => 'edit', $state['State']['id'])
			            ));?>
			            
			            <?php echo $this->Form->postLink(
			              $this->Html->image('delete.png', array('alt' => __('Delete'),'width'=>'15px','height'=>'15px')), //le image
			              array('action' => 'delete', $state['State']['id']), //le url
			              array('escape' => false), //le escape
			              __('Are you sure you want to delete # %s?', $state['State']['id']) //le confirm
			            ); ?>
		</td>
	</tr>
<?php endforeach; ?>
